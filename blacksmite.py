...
pVolume = [' VOLUME KUBUS ', ' VOLUME BALOK ', ' VOLUME BOLA', ' VOLUME TABUNG ',
           ' VOLUME SILINDER ', ' VOLUME KERUCUT ', ' VOLUME PRISMA ', ' VOLUME LIMAS ']
...
def volume(nomor):
    ...
    gambar()
    print(50*'-')
    print(pVolume[nomor - 1].center(50, '='))
    print(50*'-')
...
def vBalok(Pangjang, lebar, tinggi):
...
def vTabung(r, tinggi):
    return 3.14 * (r ** 2) * t


def vSilinder(r, tinggi):
    return 3.14 * (r ** 2) * t


def vKerucut(r, tinggi):
    return 1/3 * 3.14 * r * r * tinggi


def vPrisma(alas, tinggi):
    return (0.5 * alas * tinggi)*tinggi


def vLimas(alas, tinggi):
...
while pengulangan == 1:
    ...
    match WELCOME:
        ...
        case 4:
            ...
            print('3. Volume Bolas')
            print('4. Volume Tabung')
            print('5. Volume Silinder')
            print('6. Volume Kerucut')
            print('7. Volume Prisma')
            print('8. Volume Limas')
            print(50*'-')
            pilihan = int(input('Masukan Pilihan Operasi : '))

            match pilihan:
                case 1:
                    volume(pilihan)
                    sisi = int(input('Masukan Panjang Sisi : '))
                    print(f'Volumenya Adalah : {str(vKubus(sisi))}')
                ...
                case 2:
                    ...
                    print(
                        f'Volumenya Adalah : {str(vBalok(panjang, lebar, tinggi) )}')

                case 3:
                    volume(pilihan)
                    r = int(input('Masukan Panjang Jari-Jari : '))
                    print(f'Volumenya Adalah : {str(vBola(r))}')

                case 4:
                    volume(pilihan)
                    r = int(input('Masukan Panjang Jari-Jari : '))
                    tinggi = int(input('Masukan Tinggi : '))
                    print(f'Volumenya Adalah : {str(vTabung(r, tinggi))}')
                ...
                case 6:
                    ...
                    r = int(input('Masukan Panjang Jari-Jari : '))
                    tinggi = int(input('Masukan tinggi : '))
                    print(f'Volumenya Adalah = {str(vKerucut(r, tinggi))}')

                case 7:
                    volume(Pilihan)
                    alas = int(input('Masukan Panjang Alas : '))
                    tinggi = int(input('Masukan Tinggi: '))
                    print(f'Volumenya Adalah = {str(vPrisma(alas, tinggi))}')
